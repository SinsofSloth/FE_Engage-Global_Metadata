// Namespace: 
public enum NexKillBonus.Kinds // TypeDefIndex: 12728
{
	// Fields
	public int value__; // 0x0
	public const NexKillBonus.Kinds Kill = 0;
	public const NexKillBonus.Kinds Killed = 1;
	public const NexKillBonus.Kinds Max = 2;
}

// Namespace: 
private enum NexKillBonus.ServerSequence.Label // TypeDefIndex: 12729
{
	// Fields
	public int value__; // 0x0
	public const NexKillBonus.ServerSequence.Label SearchData = 0;
	public const NexKillBonus.ServerSequence.Label SearchSelfData = 1;
	public const NexKillBonus.ServerSequence.Label DeleteData = 2;
	public const NexKillBonus.ServerSequence.Label GetData = 3;
	public const NexKillBonus.ServerSequence.Label PostData = 4;
	public const NexKillBonus.ServerSequence.Label UpdateData = 5;
	public const NexKillBonus.ServerSequence.Label Succeeded = 6;
	public const NexKillBonus.ServerSequence.Label Error = 7;
	public const NexKillBonus.ServerSequence.Label End = 8;
}

// Namespace: 
private enum NexKillBonus.ServerSequence.Mode // TypeDefIndex: 12730
{
	// Fields
	public int value__; // 0x0
	public const NexKillBonus.ServerSequence.Mode Download = 0;
	public const NexKillBonus.ServerSequence.Mode Upload = 1;
}
