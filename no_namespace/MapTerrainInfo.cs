// Namespace: 
private enum MapTerrainInfo.Element // TypeDefIndex: 12487
{
	// Fields
	public int value__; // 0x0
	public const MapTerrainInfo.Element Effects = 0;
	public const MapTerrainInfo.Element Avoid = 1;
	public const MapTerrainInfo.Element Def = 2;
	public const MapTerrainInfo.Element Res = 3;
	public const MapTerrainInfo.Element Heal = 4;
	public const MapTerrainInfo.Element Damage = 5;
	public const MapTerrainInfo.Element Move = 6;
	public const MapTerrainInfo.Element PlayerDef = 7;
	public const MapTerrainInfo.Element EnemyDef = 8;
	public const MapTerrainInfo.Element Stun = 9;
	public const MapTerrainInfo.Element Other = 10;
	public const MapTerrainInfo.Element Sight = 11;
	public const MapTerrainInfo.Element CannonRoot = 12;
	public const MapTerrainInfo.Element Stock = 13;
	public const MapTerrainInfo.Element Attack = 14;
	public const MapTerrainInfo.Element Hit = 15;
	public const MapTerrainInfo.Element Title = 16;
	public const MapTerrainInfo.Element TerrainName = 17;
	public const MapTerrainInfo.Element Overlap = 18;
	public const MapTerrainInfo.Element Num = 19;
}

// Namespace: 
public enum MapTerrainInfo.Side // TypeDefIndex: 12488
{
	// Fields
	public int value__; // 0x0
	public const MapTerrainInfo.Side Left = 0;
	public const MapTerrainInfo.Side Right = 1;
	public const MapTerrainInfo.Side Num = 2;
}
